        ...
        when (view!!.id) {
            ...
            R.id.btn_gen_2nos -> {
                ...
                for (i in 1..2){
                    ...
                    if (i==2){
                        var sixNumbers = SixNumber(result17[7], result28[8], result39[9], result410[10], result511[11], result612[12])
                        sixNumberList.add(sixNumbers)
                    }
                }
            ...
            R.id.btn_gen_40nos -> {
                ...
                for (i in 1..40){
                    ...
                    if (i==3){
                        var sixNumbers = SixNumber(result17[13], result28[14], result39[15], result410[16], result511[17], result612[18])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==4){
                        var sixNumbers = SixNumber(result17[19], result28[20], result39[21], result410[22], result511[23], result612[24])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==5){
                        var sixNumbers = SixNumber(result17[24], result28[23], result39[22], result410[21], result511[20], result612[19])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==6){
                        var sixNumbers = SixNumber(result17[18], result28[17], result39[16], result410[15], result511[14], result612[13])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==7){
                        var sixNumbers = SixNumber(result17[12], result28[11], result39[10], result410[9], result511[8], result612[7])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==8){
                        var sixNumbers = SixNumber(result17[6], result28[5], result39[4], result410[3], result511[2], result612[1])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==9){
                        var sixNumbers = SixNumber(result17[1], result28[3], result39[5], result410[7], result511[9], result612[11])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==10){
                        var sixNumbers = SixNumber(result17[11], result28[13], result39[15], result410[17], result511[19], result612[21])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==11){
                        var sixNumbers = SixNumber(result17[21], result28[23], result39[1], result410[3], result511[5], result612[7])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==12){
                        var sixNumbers = SixNumber(result17[7], result28[10], result39[13], result410[16], result511[19], result612[22])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==13){
                        var sixNumbers = SixNumber(result17[22], result28[24], result39[1], result410[2], result511[3], result612[4])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==14){
                        var sixNumbers = SixNumber(result17[2], result28[4], result39[6], result410[8], result511[18], result612[12])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==15){
                        var sixNumbers = SixNumber(result17[12], result28[14], result39[16], result410[18], result511[20], result612[22])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==16){
                        var sixNumbers = SixNumber(result17[24], result28[18], result39[12], result410[6], result511[2], result612[1])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==17){
                        var sixNumbers = SixNumber(result17[3], result28[6], result39[9], result410[12], result511[15], result612[18])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==18){
                        var sixNumbers = SixNumber(result17[4], result28[8], result39[12], result410[16], result511[20], result612[24])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==19){
                        var sixNumbers = SixNumber(result17[24], result28[20], result39[16], result410[12], result511[8], result612[4])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==20){
                        var sixNumbers = SixNumber(result17[18], result28[15], result39[12], result410[9], result511[6], result612[3])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==21){
                        var sixNumbers = SixNumber(result17[1], result28[2], result39[6], result410[12], result511[18], result612[24])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==22){
                        var sixNumbers = SixNumber(result17[7], result28[14], result39[21], result410[2], result511[4], result612[6])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==23){
                        var sixNumbers = SixNumber(result17[6], result28[4], result39[2], result410[21], result511[14], result612[7])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==24){
                        var sixNumbers = SixNumber(result17[8], result28[16], result39[24], result410[8], result511[10], result612[12])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==25){
                        var sixNumbers = SixNumber(result17[9], result28[18], result39[14], result410[16], result511[18], result612[20])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==26){
                        var sixNumbers = SixNumber(result17[10], result28[20], result39[21], result410[22], result511[23], result612[24])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==27){
                        var sixNumbers = SixNumber(result17[11], result28[22], result39[3], result410[6], result511[9], result612[12])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==28){
                        var sixNumbers = SixNumber(result17[12], result28[9], result39[6], result410[3], result511[22], result612[11])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==29){
                        var sixNumbers = SixNumber(result17[12], result28[24], result39[15], result410[18], result511[21], result612[24])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==30){
                        var sixNumbers = SixNumber(result17[13], result28[12], result39[11], result410[10], result511[11], result612[12])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==31){
                        var sixNumbers = SixNumber(result17[2], result28[1], result39[4], result410[3], result511[6], result612[5])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==32){
                        var sixNumbers = SixNumber(result17[8], result28[7], result39[10], result410[9], result511[12], result612[11])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==33){
                        var sixNumbers = SixNumber(result17[14], result28[13], result39[16], result410[15], result511[18], result612[17])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==34){
                        var sixNumbers = SixNumber(result17[19], result28[18], result39[21], result410[20], result511[22], result612[21])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==35){
                        var sixNumbers = SixNumber(result17[24], result28[23], result39[9], result410[10], result511[11], result612[12])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==36){
                        var sixNumbers = SixNumber(result17[1], result28[4], result39[8], result410[12], result511[16], result612[20])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==37){
                    ...
                    if (i==38){
                        var sixNumbers = SixNumber(result17[8], result28[11], result39[14], result410[17], result511[20], result612[23])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==39){
                        var sixNumbers = SixNumber(result17[9], result28[13], result39[17], result410[21], result511[11], result612[12])
                        sixNumberList.add(sixNumbers)
                    }
                    if (i==40){
                        var sixNumbers = SixNumber(result17[4], result28[7], result39[11], result410[15], result511[19], result612[23])
                        sixNumberList.add(sixNumbers)
                    }
                }
